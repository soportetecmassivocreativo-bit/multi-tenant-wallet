...
export default async function ProformaPrintPage({
  ...
  return (
    <div className="proforma-print-wrapper min-h-[100dvh] bg-neutral-100 py-6 px-2 sm:px-4 text-[#14151A]">
      ...
      <div className="proforma-sheet mx-auto w-full max-w-[760px] bg-white rounded-2xl shadow-xl border border-neutral-200 overflow-hidden flex flex-col justify-between relative text-neutral-900 min-h-[900px] mb-8">
        ...
        <div className="p-6 sm:p-7 space-y-3.5 flex-1 flex flex-col justify-between">
          ...
          <div className="pt-3 border-t border-neutral-200 flex items-center justify-between text-[9.5px] text-neutral-400">
      ...
      {showConditions && hasAnyCondition && (
        <div className="page-break proforma-sheet mx-auto w-full max-w-[760px] bg-white rounded-2xl shadow-xl border border-neutral-200 overflow-hidden flex flex-col justify-between relative text-neutral-900 min-h-[900px]">
